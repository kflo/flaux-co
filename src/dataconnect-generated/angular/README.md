...
## ListTeamMembers
You can execute the `ListTeamMembers` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectListTeamMembers(options?: ListTeamMembersOptions, injector?: Injector): CreateDataConnectQueryResult<ListTeamMembersData, undefined>;
```

### Variables
The `ListTeamMembers` Query has no variables.
### Return Type
Recall that calling the `ListTeamMembers` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.
...
To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `ListTeamMembers` Query is of type `ListTeamMembersData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListTeamMembers`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectListTeamMembers, ListTeamMembersOptions } from '@dataconnect/generated/angular'
...
export class MyComponent {
  ...
  query = injectListTeamMembers();

  // You can also pass in an options function (not object) of type `ListTeamMembersOptions` to the Query injector function.
  options: ListTeamMembersOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectListTeamMembers(this.options);
}
```

## GetAgencyInfo
You can execute the `GetAgencyInfo` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectGetAgencyInfo(options?: GetAgencyInfoOptions, injector?: Injector): CreateDataConnectQueryResult<GetAgencyInfoData, undefined>;
```

### Variables
The `GetAgencyInfo` Query has no variables.
### Return Type
Recall that calling the `GetAgencyInfo` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `CreateDataConnectQueryResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectQueryResult.isPending()`, `CreateDataConnectQueryResult.isSuccess()`, and `CreateDataConnectQueryResult.isError()` functions.

To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `GetAgencyInfo` Query is of type `GetAgencyInfoData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `GetAgencyInfo`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectGetAgencyInfo, GetAgencyInfoOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Since the execution of the query is eager, you don't have to call `execute` to "execute" the Query.
  // Call the Query injector function to get a `CreateDataConnectQueryResult` object which holds the state of your Query.
  query = injectGetAgencyInfo();

  // You can also pass in an options function (not object) of type `GetAgencyInfoOptions` to the Query injector function.
  options: GetAgencyInfoOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectGetAgencyInfo(this.options);
}
```
...
## ListTestimonials
You can execute the `ListTestimonials` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectListTestimonials(options?: ListTestimonialsOptions, injector?: Injector): CreateDataConnectQueryResult<ListTestimonialsData, undefined>;
```

### Variables
The `ListTestimonials` Query has no variables.
### Return Type
Recall that calling the `ListTestimonials` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `CreateDataConnectQueryResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectQueryResult.isPending()`, `CreateDataConnectQueryResult.isSuccess()`, and `CreateDataConnectQueryResult.isError()` functions.

To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `ListTestimonials` Query is of type `ListTestimonialsData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListTestimonials`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectListTestimonials, ListTestimonialsOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Since the execution of the query is eager, you don't have to call `execute` to "execute" the Query.
  // Call the Query injector function to get a `CreateDataConnectQueryResult` object which holds the state of your Query.
  query = injectListTestimonials();

  // You can also pass in an options function (not object) of type `ListTestimonialsOptions` to the Query injector function.
  options: ListTestimonialsOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectListTestimonials(this.options);
}
```
